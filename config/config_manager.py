    ...
    def load_all_configs(self) -> None:
        with self._lock:
            ...
            if hasattr(self, '_config_watcher') and self._config_watcher:
                self._config_watcher.add_watch(self.app_categories_path)
                self._config_watcher.add_watch(self.scoring_rules_path)
                self._config_watcher.add_watch(self.cross_factors_path)
                self._config_watcher.add_watch(self.gpu_config_path)
                self._config_watcher.add_watch(self.priority_rules_path)
